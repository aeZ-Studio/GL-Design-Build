...
export const portfolioData: PortfolioItem[] = [
    // KITCHEN
    {
        ...
        descKo: "어색한 기둥으로 막혀있던 동선을 디자인 혁신을 통해 넓고 럭셔리한 키친으로 대폭 업그레이드했습니다. (GL만의 공간 이해도가 돋보이는 작품)",
        image: "kitchen-1.jpg",
    ...
    },
    {
        ...
        descKo: "벽 철거라는 큰 변화를 통해 실현한 최신 오픈주방입니다. 공간의 한계를 넘어서는 GL의 최신 트렌드와 디자인 기술력이 집약된 작품입니다.",
    ...
    },
    {
        ...
        descKo: "단순한 복구를 넘어, 화재의 흔적을 완벽히 지우고 **안전**과 미적 완성도를 더 높여 재탄생시켰습니다. (미국 목조주택의 근본적 이해 필요)",
        image: "home-13.jpg",
