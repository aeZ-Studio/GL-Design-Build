...
export const portfolioData: PortfolioItem[] = [
    // KITCHEN
    {
        id: 101,
        category: 'kitchen',
        titleEn: "Luxury Kitchen & Structural Innovation",
        titleKo: "럭셔리 키친 & 구조적 혁신",
        descEn: "Converted a restricted layout with awkward pillars into a seamless, high-end culinary flow. Modern luxury meets structural intelligence.",
        descKo: "어색한 기둥으로 막혀있던 동선을 구조적 혁신을 통해 넓고 럭셔리한 키친으로 대폭 업그레이드했습니다. (GL만의 구조 이해도가 돋보이는 작품)",
        image: "kitchen-1.jpg",
    ...
    },
    {
        ...
        descEn: "A complete structural overhaul involving wall removal to create a breathtaking open-plan living experience. The pinnacle of GL's recent trends.",
        descKo: "내력벽 철거라는 엄청난 모험을 통해 실현한 최신 오픈주방입니다. 공간의 한계를 넘어서는 GL의 최신 트렌드와 기술력이 집약된 작품입니다.",
    ...
    },
    {
        id: 13,
        category: 'improvement',
        titleEn: "Fire Damage & Structural Restoration",
        titleKo: "화재 피해 복구 및 정밀 재건축",
        descEn: "Sophisticated **restoration** that goes beyond cleaning, ensuring **structural safety** and an upgraded aesthetic after fire damage.",
        descKo: "단순한 복구를 넘어, 화재의 흔적을 완벽히 지우고 **구조적 안전**과 미적 완성도를 더 높여 재탄생시켰습니다. (미국 목조주택의 근본적 이해 필요)",
        image: "home-13.jpg",
